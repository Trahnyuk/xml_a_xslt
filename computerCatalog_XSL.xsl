...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <!--Inno3d graphic-->
        &lt; graphic_card &quot;msi&quot; &gt;
        <xsl:for-each select="compuer/hardware/graphic_cards/graphic_card_inno3d/graphic_card">
                &lt;part&gt;<xsl:value-of select="name"/><xsl:value-of select="model"/>&#x2014;<xsl:value-of select="price"/>,-&lt;/part&gt;
        </xsl:for-each>

        <!--Palit graphic-->
        &lt;graphic_card &quot;msi&quot;&gt;
        <xsl:for-each select="compuer/hardware/graphic_cards/graphic_card_palit/graphic_card">
                &lt;part&gt;<xsl:value-of select="name"/><xsl:value-of select="model"/>&#x2014;<xsl:value-of select="price"/>,-&lt;/part&gt;
        </xsl:for-each>
        ...
        <xsl:for-each select="computer/accessories/mice/mouse_basilisk/mouse">
                &lt;part&gt;
                <xsl:value-of select="name"/>
                <xsl:value-of select="connecting"/>
                &#x2014;
                <xsl:value-of select="price"/>
                ,-
                &lt;/part&gt;
